...
def construct_gluepipeline(env='',
                           generated=None,
                           previous_env=None,
                           region='us-east-1',
                           settings=None,
    ...
    if env.startswith('prod'):
        template_name = 'pipeline/pipeline_{}_gluepipeline.json.j2'.format(env)
    else:
        template_name = 'pipeline/pipeline_stages_gluepipeline.json.j2'
