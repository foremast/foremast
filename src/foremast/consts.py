...
ENV_CONFIGS = validate_key_values(CONFIG, 'base', 'env_configs', default={})
...
LAMBDA_STANDALONE_MODE = validate_key_values(CONFIG, 'lambda', 'standalone_mode', default=False)
...
AWS_MANUAL_TYPES = set(filter(None, set(validate_key_values(CONFIG, 'base', 'aws_manual_types', default='manual')
                                        .split(','))))
AWS_TYPES = set(
    validate_key_values(CONFIG, 'base', 'aws_types', default='ec2,lambda,s3,datapipeline,stepfunction,rolling')
